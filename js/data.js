// Данные кабинета Фокус ИИ. Программа «Claude вперёд» (19 созвонов).
// Города в гео-порядке (карта), блоки переставлены: Актобе=Claude.
// groupProgress = сколько модулей ЗАВЕРШЕНО (текущий = следующий за ним).
const SITE = {
  "accessKey": "fokus2026",
  "participants": {
    "zhanara26": {
  ...
  "modules": [
    {
      ...
      "materials": [
        {
          "type": "pdf",
          "title": "Список сайтов для вдохновения",
          "url": "https://drive.google.com/file/d/1gn19Kkkb5F2E6jwTtX14MT3aJpXOlh0T/view"
        }
      ],
      "homeworks": [
        {
          "call": 2,
          "title": "Плохой промпт против хорошего — на своей задаче",
          "deadline": "до следующего созвона",
          "intro": "Возьми ОДНУ реальную задачу и почувствуй разницу руками: один и тот же ИИ, но плохой и хороший запрос дают разный результат.",
          "steps": [
            "Выбери реальную задачу из работы или жизни (пост, письмо, план — что угодно нужное тебе).",
            "Промпт А (плохой): напиши запрос в 1 строку, как «в гугл». Сохрани ответ.",
            "Промпт Б (хороший): перепиши детально, закрой минимум 4 из 6 пунктов — роль, задача, контекст, формат, тон, пример/ограничение. Сохрани ответ.",
            "Прогони минимум в 2 из 3 нейросетей (Claude / ChatGPT / Gemini) — сравни характер ответов.",
            "Напиши вывод (3–5 предложений): что изменилось между А и Б и какая модель понравилась больше."
          ],
          "criteria": [
            "Промпт Б реально детальный — видно минимум 4 пункта чек-листа",
            "Разница между А и Б описана своими словами",
            "Протестировано минимум в 2 нейросетях",
            "Есть личный вывод, а не «всё понятно»"
          ]
        }
      ]
    },
    {
      ...
      "materials": [
        {
          "type": "pdf",
          "title": "Как выбрать нейросеть под твои задачи",
          "url": "https://drive.google.com/file/d/1HzsxugAF7Klx7HDUdO3juHE4iwyUb4ZP/view"
        }
      ],
      "homeworks": [
        {
          "title": "Тест-драйв моделей + промпт для картинки",
          "deadline": "до следующего созвона",
          "intro": "Почувствуй характер каждой модели руками: одна задача — несколько нейросетей, и сравни, кто отвечает лучше под ЭТУ задачу.",
          "steps": [
            "Возьми свою реальную задачу и прогони её детальным промптом минимум в 3 моделях: Claude + ещё две (ChatGPT / Gemini / Perplexity / Grok).",
            "Попроси LLM написать английский промпт для картинки под твою рекламу — сохрани его.",
            "Напиши вывод на 3–5 предложений: кто ответил лучше под эту задачу и почему, какую модель оставляешь себе."
          ],
          "criteria": [
            "Задача протестирована минимум в 3 моделях",
            "Есть готовый английский промпт для картинки",
            "Сравнение по делу, а не «всё понравилось»",
            "Личный вывод «что беру под что»"
          ]
        }
      ]
    },
    {
      ...
      "calls": 3,
      "overview": "Самый жирный блок программы — идёт в 3 созвона: Chat (общение и тексты) → Cowork (работа и автоматизация) → Code (сайты и приложения). Claude как рабочий инструмент креатора: проект под твой бизнес и коннекторы, лендинг для клиента за час (artifact → деплой на Netlify), Telegram-бот приёма заказов, автоматизация рутины через Notion + Claude. Это навык, который в Казахстане пока есть у единиц — и который удваивает твой чек.",
      ...
      "homeworks": [
        {
          "title": "Claude Chat: проект своего бизнеса",
          "deadline": "до следующего созвона",
          "intro": "Настрой Claude под свой бизнес как полноценного помощника: отдельный проект, кастомные инструкции и подключённый коннектор.",
          "steps": [
            "Создай проект «[Название твоего бизнеса]» в Claude.",
            "Напиши кастомные инструкции: роль + целевая аудитория + тон + что нельзя.",
            "Подключи хотя бы 1 коннектор (Gmail, Google Календарь, Notion и т.п.).",
            "Сделай 3 запроса с артефактами — приложи скрин результата."
          ],
          "criteria": [
            "Создан отдельный проект под бизнес",
            "Прописаны кастомные инструкции (роль / ЦА / тон / ограничения)",
            "Подключён минимум 1 коннектор",
            "3 запроса с артефактами + скрин результата"
          ]
        }
      ]
    },
      ...
      "materials": [
        {
          ...
          "url": "https://drive.google.com/file/d/1u1PID0nualj23Qztvu-qMl3-a100LA9Q/view"
        },
        {
          "type": "pdf",
          "title": "Лучшие промпты в 7 разных сферах",
          "url": "https://drive.google.com/file/d/1NraHY-RbfK-TsAprUIXgAQ0TMA9gjbVy/view"
        },
        {
          "type": "pdf",
          "title": "Промпты и шаблоны",
          "url": "https://drive.google.com/file/d/1vTztRbBcR8-FhnyJCH8CTFXtrlP0EQWB/view"
        }
      ]
    },
    {
      ...
      "materials": [
        {
          "type": "pdf",
          "title": "Свет",
          "url": "https://drive.google.com/file/d/1D0myuBC0r7U1vSrGuIF97KaQScZzkSGr/view"
        },
        {
          "type": "pdf",
          "title": "Ракурс",
          "url": "https://drive.google.com/file/d/1ILOXR-hiAOqbg8exyoMb-BEmKg49vovo/view"
        },
        {
          "type": "pdf",
          "title": "Камера, объектив, линзы",
          "url": "https://drive.google.com/file/d/1KEWP4IZWvLb8EgMdlNnfUf0JcvOoiKtx/view"
        },
        {
          "type": "pdf",
          "title": "Стили",
          "url": "https://drive.google.com/file/d/1rJiu_cvM-nSdJo2ym7WMSBYBzjlAVJWf/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Еда",
          "url": "https://drive.google.com/file/d/1s6jnhX9CZdvGe0sqpQnwHqL3rlt9uaqj/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Парфюм",
          "url": "https://drive.google.com/file/d/1DpBcKDTWz7KvY4KwnFK4mzfF-9mPXzxy/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Одежда",
          "url": "https://drive.google.com/file/d/1qWPU2uZtYQMgipO_NpfIIbgobr88FnRL/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Кино",
          "url": "https://drive.google.com/file/d/1NPdrHDwPxzZNxsAyj91ummoQrXxqB-fp/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Ювелирные изделия",
          "url": "https://drive.google.com/file/d/1ruwcbXjg8MwKf1oQkk0fKBngJafLV6zX/view"
        },
        {
          "type": "pdf",
          "title": "Промпты по сферам: Строительство",
          "url": "https://drive.google.com/file/d/1WAmG0Q2oZW8rGhwEjG5Jl0MjymJ4_Uwo/view"
        }
      ]
    },
    {
      ...
      "materials": [
        {
          ...
          "url": "https://drive.google.com/file/d/1giEHRzZKAtgcbCwAx1f6m1EUcOhIUzod/view"
        },
        {
          "type": "pdf",
          "title": "Готовые промпты для видео",
          "url": "https://drive.google.com/file/d/1nMLa7hapaZPruA9b8TpDI86U_uvmhXFK/view"
        },
        {
          "type": "pdf",
          "title": "Форматы под соцсети",
          "url": "https://drive.google.com/file/d/1ydPYPW97T9I5WeIrPhaUI-myHQrihO7A/view"
        }
      ]
    },
    {
      ...
      "materials": [
        {
          "type": "pdf",
          "title": "Как подбирать звук под настроение",
          "url": "https://drive.google.com/file/d/1V9Xa-Clro1jScw1BuLSeH40xvG1BhONi/view"
        }
      ]
    },
    {
  ...
  "library": [
    {
      "type": "link",
      "title": "Вся папка раздаточных материалов (Google Drive)",
      "url": "https://drive.google.com/drive/folders/19XATtUlaZNb6pPodKeMscz1HtjelTWw5"
    },
    {
      "type": "pdf",
      "title": "Список приложений для ведения Instagram",
      "url": "https://drive.google.com/file/d/1BeUmwsDeJFsx0BR1mHBOzAp0ru5M0Gu1/view"
    },
    {
      "type": "link",
      "title": "Список из 100 нейросетей",
      "url": "https://app.notion.com/p/26f4399e3bf3808898fcf7430daff059?v=26f4399e3bf380a2a683000c3d20d6eb&source=copy_link"
    }
  ]
};
